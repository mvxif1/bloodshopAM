    ...
    $("#form3").submit(function (e) {
        ...
        if (telefono !== '') {
            ...
            if (!telefonoRegex.test(telefono)) {
                msjMostrar5 += "El teléfono debe contener 9 dígitos numéricos";
                enviartel = true;
            }
        }

        if (enviartel) {
            $("#incompleto5").css("color", "red");
            $("#incompleto5").html(msjMostrar5);
        } else {
            $("#incompleto5").css("color", "green");
            $("#incompleto5").html("Completado");
        }
